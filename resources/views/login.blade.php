...
<div class="container container--wide">
  <div class="card !grid grid-cols-2">
    ...
    <div class="p-16">
      ...
      <div class="bg-teal-100 content p-6 mb-6">
      

  {!! str_replace('[register]', "<a href='" . get_field('registration_page', 'option'). "'>register an account</a>", get_field('login_page_message', 'option')) !!}
  ...
  <div class="control">
    <input class="input" type="text" name="log" required id="user_login" placeholder="Username or Email">
  </div>
  ...
  <div class="control">
    ...
    <div class="mt-4 control flex items-center justify-between">
