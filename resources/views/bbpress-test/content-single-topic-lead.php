...
<ul id="bbp-topic-<?php bbp_topic_id(); ?>-lead" class="bbp-lead-topic">
	...
	<li class="bbp-header">
		...
		<div class="bbp-topic-author"><?php esc_html_e( 'Creator',  'docly' ); ?></div><!-- .bbp-topic-author -->
	...
	<li class="bbp-body">
		...
		<div class="bbp-topic-header">
			...
			<div class="bbp-meta">
				...
				<span class="bbp-topic-post-date"> <?php bbp_topic_post_date(get_the_ID()); ?> </span>
	...
	<li class="bbp-footer">
		...
		<div class="bbp-topic-author"><?php esc_html_e( 'Creator',  'docly' ); ?></div>
