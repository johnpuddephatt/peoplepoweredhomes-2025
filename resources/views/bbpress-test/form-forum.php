        ...
        <form id="new-post" name="new-post" method="post">
            ...
            <fieldset class="bbp-form">
                <legend>
                    ...
                    <?php
                    if ( bbp_is_forum_edit() ) :
                        printf( esc_html__( 'Now Editing &ldquo;%s&rdquo;', 'docly' ), bbp_get_forum_title() );
                    else :
                        bbp_is_single_forum()
                            ? printf( esc_html__( 'Create New Forum in &ldquo;%s&rdquo;', 'docly' ), bbp_get_forum_title() )
                            : esc_html_e( 'Create New Forum', 'docly' );
                    endif;
                    ?>
                ...
                <div>
                    ...
                    <p>
                        <label for="bbp_forum_title"><?php printf( esc_html__( 'Forum Name (Maximum Length: %d):', 'docly' ), bbp_get_title_max_length() ); ?></label><br />
                    ...
                    <?php if ( bbp_allow_forum_mods() && current_user_can( 'assign_moderators' ) ) : ?>
                        ...
                        <p>
                            <label for="bbp_moderators"><?php esc_html_e( 'Forum Moderators:', 'docly' ); ?></label><br />
                    ...
                    <p>
                        <label for="bbp_forum_type"><?php esc_html_e( 'Forum Type:', 'docly' ); ?></label><br />
                    ...
                    <p>
                        <label for="bbp_forum_status"><?php esc_html_e( 'Status:', 'docly' ); ?></label><br />
                    ...
                    <p>
                        <label for="bbp_forum_visibility"><?php esc_html_e( 'Visibility:', 'docly' ); ?></label><br />
                    ...
                    <p>
                        <label for="bbp_forum_parent_id"><?php esc_html_e( 'Parent Forum:', 'docly' ); ?></label><br />

                        <?php
                        bbp_dropdown( array(
                            'select_id' => 'bbp_forum_parent_id',
                            'show_none' => esc_html__( '&mdash; No parent &mdash;', 'docly' ),
...
<?php elseif ( bbp_is_forum_closed() ) : ?>
    ...
    <div id="no-forum-<?php bbp_forum_id(); ?>" class="bbp-no-forum">
        <div class="bbp-template-notice">
            <ul>
                <li><?php printf( esc_html__( 'The forum &#8216;%s&#8217; is closed to new content.', 'docly' ), bbp_get_forum_title() ); ?></li>
            </ul>
        </div>
    </div>
        ...
        <div class="bbp-template-notice">
            <ul>
                <li><?php is_user_logged_in()
                        ? esc_html_e( 'You cannot create new forums.',               'docly' )
                        : esc_html_e( 'You must be logged in to create new forums.', 'docly' );
                    ?></li>
            </ul>
        </div>
    </div>
