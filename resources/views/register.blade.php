    ...
    if (empty($errors)) {
        ...
        if (!is_wp_error($user_id)) {
            ...
            if (!empty($admin_emails)) {
                ...
                $message = str_replace('[user]', '<a href="' . admin_url('user-edit.php?user_id=' . $user->ID ) . '">View this user</a>', get_field('new_registration_email', 'option'));
...
@section('content')
  ...
  <div class="card mx-auto max-w-2xl ">
    ...
    <div class="p-16">
      ...
      <div class="bg-teal-100 p-6 mb-6">
  If you’re a member of a group we’re working with but haven’t created a login yet, <a href="/register" class="underline">register an account</a>. 
      </div>
